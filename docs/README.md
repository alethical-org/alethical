...
- [How private account visibility works](product-onboarding/admin-users-guide.md) — the approved administrator accounts, private account search, confirmation dates, exclusions, and access protection
- [How Site Metrics works](product-onboarding/traffic-guide.md) — public traffic, sign-ups, Money use, source health, and the private aggregate leadership report
...
- [How the lobbying pages work](product-onboarding/lobbying-guide.md) — current registrations, yearly principal spending, exact-number donations and the 5 public addresses
...
- [Reviewing a failed campaign-money collection — decisions](architecture/collection-failure-review-decisions.md) — what happens when the daily refresh or the notices collection fails: 1 issue per problem, what the evidence packet removes, what each job may touch, the switched-off AI reviewer and its limits, and when an issue closes
