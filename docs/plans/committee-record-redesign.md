...
Hosted preview checkpoint: [commit 2fcded11](https://github.com/alethical-org/alethical/commit/2fcded115212e8ad591e77ca8d6725cbf3e03ef9) exceeded startup budget by 34 bytes; auto-merge disabled before release. Small loop changes did not reliably improve compressed size and were discarded. Moved unchanged payment-name role/heading/request-size definitions into a dependency-free leaf so startup stops loading screen-only grouping and formatting. Local startup 337,261 bytes; 3,092 tests and TypeScript pass; independent review clear. Hosted checks, queue, deployment and live evidence remain.
