...
The `scripts/` folder has 41 runnable files. GitHub jobs call 10 of them, and the
...
| Check data, code, and documents | `check_bill_section_gaps.py`, `check_campaign_finance_stated_split.py`, `check_declared_dependencies.py`, `check_doc_quotes.py`, `check_doc_references.py`, `check_doc_sync.py`, `check_home_hero_card_literals.py`, `check_no_nul_bytes.py`, `check_rag_coverage.py`, `check_schema_drift.py` |
