...
7. Run focused and repository checks, send the coordinating task the review package, apply its findings, then merge, deploy, and check live regressions. [Pull request 2380](https://github.com/alethical-org/alethical/pull/2380) carries the review and release record.
