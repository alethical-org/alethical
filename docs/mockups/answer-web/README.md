...
- **"From the bill" rail** — heading + **"Cited Sections"** with the green circle-check.
  ...
  purple mono chip per card (`Art. 1, Sec. N · Title →`), flush-left italic quote with
  **no quotation marks**. The chip sits 8px above the first quote; later quotes in the same
  section are 15px apart.
...
- Surfaces: page `#fbfcfd`; white cards; quiet card `#f7f9f8`; issue chip `#f1f1f4`; vote
  chip `#e4f8ee`; hairlines `rgba(17,21,15,0.07–0.16)`.
