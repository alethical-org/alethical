...
> "✦ Ask" (nav), never "Ask AI" (`docs/design/ui-copy-guide.md`). **Held pending Grounded Ask
...
- "Cited ✓ Section 325M.40"; three quoted section cards (no numbered chips or decorative
  rules, flush-left italic quotes).
