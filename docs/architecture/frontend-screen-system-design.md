...
> `docs/product-and-onboarding/mvp-redesign-plan.md` § Locked decisions — including the top-nav shell (this doc
...
> (`docs/product-and-onboarding/bill-search-screen-spec.md`) and the mockup bundles under `docs/mockups/`. Visual,
...
> into two dedicated screens (`docs/product-and-onboarding/mvp-redesign-plan.md` § Search page split). The bill
> search screen is specified in `docs/product-and-onboarding/bill-search-screen-spec.md`, which is authoritative;
...
> **See `docs/product-and-onboarding/bill-search-screen-spec.md`** for the authoritative bill search screen.
