...
class AskIntent(str, Enum):
    ...
    ``docs/product-onboarding/grounded-ask-spec.md`` §4.1 (Question router) 1:1.
    """
...
# questions route to topic_bills, never a prose answer (docs/product-onboarding/grounded-ask-spec.md
...
# ``topic`` feeds the topic answer paths (docs/product-onboarding/grounded-ask-spec.md §4.2).
...
def pick_bill_from_candidates(
    ...
    list (docs/product-onboarding/grounded-ask-spec.md §4.1 semantic resolution; #266). Each
