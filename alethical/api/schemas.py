...
class AskTopicBillsAnswer(BaseModel):
    """Cited topic → bills answer (docs/product-and-onboarding/grounded-ask-spec.md §4.2, topic_bills).
...
class AskLegislatorBillRef(BaseModel):
    ...
    an authorship count (docs/product-and-onboarding/grounded-ask-spec.md §4.2, topic_legislators)."""
...
class AskTopicLegislatorsAnswer(BaseModel):
    """Authorship-framed legislator list (docs/product-and-onboarding/grounded-ask-spec.md §4.2/§4.3).
...
class AskVoteDeflectionAnswer(BaseModel):
    """v1 honest vote deflection (docs/product-and-onboarding/grounded-ask-spec.md §4.5 / §9.4, Vote
...
class AskCitation(BaseModel):
    """One retrieved passage backing a bill_text answer (docs/product-and-onboarding/grounded-ask-spec.md
...
class AskBillTextAnswer(BaseModel):
    """Single-bill RAG prose answer with citations (docs/product-and-onboarding/grounded-ask-spec.md
