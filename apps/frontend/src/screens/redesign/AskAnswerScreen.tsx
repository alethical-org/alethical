    ...
    <View style={[styles.billCard, t.shadows.card as object]}>
      <View style={styles.billCardTop}>
        ...
        {/* Bill tracking is a not-yet-live roadmap feature — inert dashed preview
            button, consistent site-wide (docs/product-and-onboarding/grounded-ask-spec.md §9.2). */}
        <RoadmapTrackButton />
      </View>
    ...
    <PageBackground>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Container style={styles.body}>
          {/* Retry path: the persistent Ask bar (docs/product-and-onboarding/grounded-ask-spec.md §9.1). */}
          ...
          {askQuery.isLoading || resolvingName ? (
            ...
            <View style={styles.answerBlock}>
              ...
              <Text style={styles.question}>{question}</Text>
              {/* Fixed deflection copy owned by the layout (docs/product-and-onboarding/grounded-ask-spec.md
            ...
            <View style={styles.answerBlock}>
              ...
              {/* Fixed framing copy owned by the layout, never LLM output
                  (docs/product-and-onboarding/grounded-ask-spec.md §4.3; .claude/rules/grounded-answers.md rule 3). */}
