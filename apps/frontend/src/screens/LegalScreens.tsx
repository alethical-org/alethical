...
const privacyContent: LegalDocumentContent = {
  ...
  meta: 'Effective date: August 15, 2026 · Last updated: September 7, 2026',
  sections: [
    {
      blocks: [
        {
