      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Account creation totals: Alethical counts accounts still present in Supabase, including accounts awaiting email confirmation. Closed, banned, anonymous, team, and test accounts are excluded. Linked sign-in records count as 1 account. Deleted accounts are not included, so past creation totals can decrease. Public metrics and the administrator-only /admin/metrics report show combined counts, not names, email addresses, or individual activity.',
