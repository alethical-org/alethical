 ...
 */
const AccountScreen = loadOnDemand(screenChunks.Account);
const ChatScreen = loadOnDemand(screenChunks.Chat);
const ChatSessionScreen = loadOnDemand(screenChunks.ChatSession);
const FindMyLegislatorScreen = loadOnDemand(screenChunks.FindMyLegislator);
const LegislatorProfileScreen = loadOnDemand(screenChunks.LegislatorProfile);
...
const CommitteeMoneyScreen = loadOnDemand(screenChunks.CommitteeMoney);
