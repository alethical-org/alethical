...
const styles = StyleSheet.create({
  ...
  metaText: { fontFamily: t.typography.mono, fontSize: t.fontSizes.meta, letterSpacing: 1.4, color: t.colors.text.muted },
  ...
  eyebrowText: { fontFamily: t.typography.mono, fontSize: t.fontSizes.meta, fontWeight: t.fontWeights.bold, letterSpacing: 2.2, color: t.colors.brand.deep },
  sectionLabel: { fontFamily: t.typography.mono, fontSize: t.fontSizes.meta, fontWeight: t.fontWeights.bold, letterSpacing: 2.4, color: t.colors.brand.deep },
  labelMono: { fontFamily: t.typography.mono, fontSize: t.fontSizes.label, letterSpacing: 1.6, color: t.colors.text.muted },
  ...
  viewAllText: { fontFamily: t.typography.mono, fontSize: t.fontSizes.label, fontWeight: t.fontWeights.bold, letterSpacing: 1.8, color: t.colors.text.primary },
  infoCard: {
    flex: 1,
    minWidth: 200,
    flexDirection: 'row',
