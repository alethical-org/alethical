...
const styles = StyleSheet.create({
  ...
  metaText: { fontFamily: t.typography.ui, fontSize: t.fontSizes.meta, fontWeight: t.fontWeights.medium, letterSpacing: 1.2, color: t.colors.text.muted },
  ...
  eyebrowText: { fontFamily: t.typography.ui, fontSize: t.fontSizes.meta, fontWeight: t.fontWeights.bold, letterSpacing: 2, color: t.colors.brand.deep },
