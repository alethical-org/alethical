...
// The 2 formatters live in `./moneyFormat` so a screen that prints a figure does not
// carry this module's wording; they are re-exported here for the callers that always
// took them from this file.
export { formatDay, formatMoney } from './moneyFormat';
...
} from './campaignMoneyYears';
export type { CampaignMoneyYear } from './campaignMoneyYears';
