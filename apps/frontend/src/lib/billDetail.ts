...
import { completeDanglingTitle } from './billStatus';
...
// components. Lasting behavior: docs/product-onboarding/bill-detail-guide.md.
...
// curated, plain-language timeline (docs/product-onboarding/bill-detail-guide.md
// §Actions; issue #552). buildActionTimeline() is the single entry point;
...
// The 3 plain-language summary cleaners live in their own file, so the shared
// page-wording file can use one without this module and its imports landing in
// every page's first download (`billSummaryText.ts` says what that measured).
// Re-exported here because every existing caller takes them from this module.
export { firstSentence, plainBillSummary, plainKeyPoints } from './billSummaryText';
...
// The document a "Read the full law / Read the bill text" link should open (see
// `docs/product-onboarding/bill-detail-guide.md` §Versions and Bill Text
