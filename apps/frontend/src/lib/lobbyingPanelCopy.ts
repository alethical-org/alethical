...
export const lobbyingPanelCopy = {
  loading: "Loading the Board's lobbyist list",
  unavailable: "Could not load this registration from the Board's lobbyist list.",
  retry: 'Try again',
  ...
  notRegistered: (number: string) => `Registration ${number} · not listed on the copy date`,
